...
# Chapter 22: Synthetic Data Generation
...
- Understand key principles of Synthetic Data Generation
...
class Chapter22Example(Node):
    def __init__(self):
        super().__init__('chapter_22_example')
        self.get_logger().info('Chapter 22: Synthetic Data Generation')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter22Example()
    rclpy.spin(node)
