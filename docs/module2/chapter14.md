...
# Chapter 14: URDF & SDF Robot Models
...
- Understand key principles of URDF & SDF Robot Models
...
class Chapter14Example(Node):
    def __init__(self):
        super().__init__('chapter_14_example')
        self.get_logger().info('Chapter 14: URDF & SDF Robot Models')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter14Example()
    rclpy.spin(node)
