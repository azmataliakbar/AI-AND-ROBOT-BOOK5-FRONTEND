...
# Chapter 17: VR/AR Human-Robot Interaction
...
- Understand key principles of VR/AR Human-Robot Interaction
...
class Chapter17Example(Node):
    def __init__(self):
        super().__init__('chapter_17_example')
        self.get_logger().info('Chapter 17: VR/AR Human-Robot Interaction')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter17Example()
    rclpy.spin(node)
