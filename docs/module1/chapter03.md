...
# Chapter 3: Nodes & Communication Patterns
...
- Understand key principles of Nodes & Communication Patterns
...
class Chapter3Example(Node):
    def __init__(self):
        super().__init__('chapter_3_example')
        self.get_logger().info('Chapter 3: Nodes & Communication Patterns')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter3Example()
    rclpy.spin(node)
