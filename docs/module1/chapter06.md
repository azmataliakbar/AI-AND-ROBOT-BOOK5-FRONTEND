...
# Chapter 6: Launch Files & Parameters
...
- Understand key principles of Launch Files & Parameters
...
class Chapter6Example(Node):
    def __init__(self):
        super().__init__('chapter_6_example')
        self.get_logger().info('Chapter 6: Launch Files & Parameters')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter6Example()
    rclpy.spin(node)
