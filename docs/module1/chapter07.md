...
# Chapter 7: TF2 & Coordinate Transformations
...
- Understand key principles of TF2 & Coordinate Transformations
...
class Chapter7Example(Node):
    def __init__(self):
        super().__init__('chapter_7_example')
        self.get_logger().info('Chapter 7: TF2 & Coordinate Transformations')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter7Example()
    rclpy.spin(node)
