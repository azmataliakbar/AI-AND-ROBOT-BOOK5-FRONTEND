...
# Chapter 5: Custom Messages & Interfaces
...
- Understand key principles of Custom Messages & Interfaces
...
class Chapter5Example(Node):
    def __init__(self):
        super().__init__('chapter_5_example')
        self.get_logger().info('Chapter 5: Custom Messages & Interfaces')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter5Example()
    rclpy.spin(node)
