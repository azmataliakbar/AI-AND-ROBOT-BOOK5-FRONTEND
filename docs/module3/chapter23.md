...
# Chapter 23: Isaac ROS Perception
...
- Understand key principles of Isaac ROS Perception
...
class Chapter23Example(Node):
    def __init__(self):
        super().__init__('chapter_23_example')
        self.get_logger().info('Chapter 23: Isaac ROS Perception')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter23Example()
    rclpy.spin(node)
