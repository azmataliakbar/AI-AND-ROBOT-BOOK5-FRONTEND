...
# Chapter 35: Human-Robot Interaction
...
- Understand key principles of Human-Robot Interaction
...
class Chapter35Example(Node):
    def __init__(self):
        super().__init__('chapter_35_example')
        self.get_logger().info('Chapter 35: Human-Robot Interaction')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter35Example()
    rclpy.spin(node)
