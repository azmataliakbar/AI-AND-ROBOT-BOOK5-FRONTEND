...
# Chapter 10: Building Python Controllers
...
- Understand key principles of Building Python Controllers
...
class Chapter10Example(Node):
    def __init__(self):
        super().__init__('chapter_10_example')
        self.get_logger().info('Chapter 10: Building Python Controllers')
        # Implementation details...

def main():
    rclpy.init()
    node = Chapter10Example()
    rclpy.spin(node)
